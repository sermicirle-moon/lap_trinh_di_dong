/**
 * FOLDER FORM - Form thêm/sửa thư mục
 * Tương tự ListForm nhưng dành cho folder
 */
          ...
          <View style={styles.container}>
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.title}>
                {mode === 'create' ? 'Thư mục mới' : 'Chỉnh sửa'}
              </Text>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.section}>
                ...
                <View style={styles.iconGrid}>
                  {['folder-outline', 'folder-open', 'shapes', 'archive', 'briefcase'].map(
                    (iconName) => (
                      <TouchableOpacity
                        key={iconName}
                        style={[
              ...
              <View style={styles.infoBox}>
                ...
                <Text style={styles.infoText}>
                  Bạn có thể thêm các danh sách vào thư mục này
                </Text>
              </View>
            </ScrollView>
          </View>
